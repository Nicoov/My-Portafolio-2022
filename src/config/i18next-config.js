    ...
    resources: {
        es: {
            translation: {
                ...
                'about-pro-4': "Aplicación que evalúa el conocimiento del usuario sobre preguntas generales, consta de 10 preguntas donde se tiene 15 segundos para responder.",
                'about-pro-5': "Pagina de anime donde se pueden buscar animes, revisar el top y mucho más. Todo esto posible con el api de JIKAN REST API.",
                "view": "Ver proyecto",
                "view-2": "Ver codigo",
                "view-3": "Ver codigo",
        ...
        en: {
            translation: {
                ...
                'about-pro-4': "Application that evaluates the user's knowledge about general questions, it consists of 10 questions where the user has 15 seconds to answer.",
                'about-pro-5': "Anime page where you can search for anime, check the top and much more, all this possible with the JIKAN REST API.",
                "view": "See proyect",
                "view-2": "View code",
                "view-3": "View code",
